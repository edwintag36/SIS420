...
Se lo hace correr en 4 celdas en Jupyter o Colab colocando el respectivo codigo en cada celda del programa
##############################
...
#Se ubica una ficha de manera aleatoria
    ...
    mapa_laberinto[fila_posicion_actual][columna_posicion_actual] = 'E'
